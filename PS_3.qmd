...
ggplot(data = pp_dist_long, aes(horn_length, color = group, linetype = PP)) +
  geom_density(position = position_dodge(width = 10))

```

How does the posterior compare to the prior?
> The prior and posterior seem to be very similar.
...
ggplot() +
  geom_density(data = lizard, aes(horn_length, color = group), linetype = "solid") +
  geom_density(data = pp_dist2_long, aes(horn_length, color = group), linetype = "dotted")
